...
const DEFAULT_VN_OFFICE_RUNTIME_URL = "http://localhost:3000/api/runtime/custom";
...
const DEFAULT_OFFICE_TITLE = "VN AI Agent Office";
...
export const resolveDefaultStudioGatewayProfile = (
  ...
  switch (adapterType) {
    case "claw3d":
      return { url: DEFAULT_VN_OFFICE_RUNTIME_URL, token: "" };
    case "local":
