...
export const buildImproveCompanyBriefPrompt = (businessDescription: string) =>
  [
    "You are helping a user describe the company they want to build inside VN AI Agent Office.",
...
export const buildGenerateCompanyPlanPrompt = (brief: string) =>
  [
    "You are designing an AI company org structure for VN AI Agent Office.",
