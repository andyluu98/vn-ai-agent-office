    ...
    >
      ...
      >
        <button
          ...
          aria-label="Đóng trình chỉnh sửa tác nhân"
        >
          <X className="h-4 w-4" />
        </button>
          ...
          <aside className="flex w-[240px] shrink-0 flex-col border-r border-border/50 bg-muted/20">
            <div className="border-b border-border/40 px-5 py-4">
              ...
              <div className="mt-1 text-xs text-muted-foreground">
                Chỉnh sửa hình đại diện và cài đặt tác nhân từ văn phòng.
              </div>
              {onNavigateAgent ? (
            ...
            {onDelete ? (
              <div className="border-t border-border/40 p-3">
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-semibold text-inherit">Xoá tác nhân</div>
                    <div className="text-xs text-red-100/85">
                      Xoá tác nhân này khỏi VN AI Agent Office và OpenClaw.
                    </div>
                  </div>
                </button>
              </div>
            ...
            {activeSection === "avatar" ? (
              ...
              <div className="flex min-h-0 flex-1 flex-col">
                <div className="border-b border-border/40 px-6 py-4">
                  <div className="font-mono text-[11px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">
                    Trình chỉnh sửa file tác nhân
                  </div>
                  <div className="mt-1 text-sm text-muted-foreground">
                    Chỉnh sửa từng file tác nhân và lưu qua cổng kết nối.
                  </div>
                </div>
              ...
              <div className="flex h-full items-center justify-center p-8 text-sm text-muted-foreground">
                Kết nối tới cổng kết nối để chỉnh sửa file tác nhân.
              </div>
            )}
          </section>
        </div>
