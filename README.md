...
[Vision](VISION.md) · [Architecture](ARCHITECTURE.md) · [Tutorial](TUTORIAL.md) · [Hướng dẫn sử dụng](docs/huong-dan-su-dung.md) · [Bắt đầu nhanh](#quick-start) · [Runtime Profiles](docs/runtime-profiles.md) · [Multi-Agent Beta](docs/multi-agent-beta.md) · [Claude Code Adapter](docs/claude-code-adapter.md) · [Contributing](CONTRIBUTING.md) · [Security](SECURITY.md)
...
- [`docs/huong-dan-su-dung.md`](docs/huong-dan-su-dung.md): hướng dẫn sử dụng đầy đủ — cài đặt, chạy, dùng office, tuỳ chỉnh agent, xử lý sự cố.
- [`docs/dong-goi-desktop-app.md`](docs/dong-goi-desktop-app.md): tư vấn đóng gói thành app desktop (.exe/.dmg) và tương thích Claude Code.
