...
> Fourth concrete office-system feature for VN AI Agent Office, completing the first real office loop: plan, coordinate, execute, review.

## Goal

Add a QA department workflow to VN AI Agent Office so the office can visibly review, test, triage, and sign off on work before it is treated as complete.
...
The QA department should plug into systems VN AI Agent Office already has.
...
VN AI Agent Office already has approval-related surfaces.
...
VN AI Agent Office already has review-adjacent UI, including GitHub-oriented immersive screens.
